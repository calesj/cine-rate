                                ...
                                <div class="mt-4 mt-sm-0">
                                    <div>
                                        <p class="mb-2"><i
                                            ...
                                            Bitcoin</p>
                                        <h6>0.4412 BTC = <span
                                                class="text-muted font-size-14 fw-normal">$ 4025.32</span></h6>
                                    </div>
                                    ...
                                    <div class="mt-4 pt-2">
                                        <p class="mb-2"><i
                                            ...
                                            Ethereum</p>
                                        <h6>4.5701 ETH = <span
                                                class="text-muted font-size-14 fw-normal">$ 1123.64</span></h6>
                                    </div>
                                    ...
                                    <div class="mt-4 pt-2">
                                        <p class="mb-2"><i
                                            ...
                                            Litecoin</p>
                                        <h6>35.3811 LTC = <span
                                                class="text-muted font-size-14 fw-normal">$ 2263.09</span></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
