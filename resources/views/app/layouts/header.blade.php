            ...
            <div class="col-12">
                <div class="header__content">
                    ...
                    <div class="header__actions">
                        <form action="{{ route('home') }}" class="header__form">
                            <input class="header__form-input" type="text" value="{{ request('search') }}" name="search" placeholder="Procure por filmes ...">
