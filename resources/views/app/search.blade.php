        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-xl-6">
                    <h1 class="section__title section__title--head">Resultados da busca</h1>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="catalog__select-wrap">
                            <select class="catalog__select" name="genres">
                                ...
                                @foreach(genres() as $genre)
                                    <option {{ $genre->slug === request('category') ? 'selected' : '' }} value="{{ $genre->slug }}">{{ $genre->name }}</option>
                                @endforeach
                            </select>
                        </div>
                            ...
                            <div class="col-12 col-md-6 col-xl-4">
                                <div class="card card--big">
                                    ...
                                    <div class="card__content">
                                        ...
                                        <ul class="card__info">
                                            <p class="card__tagline">{{ limitString($movie->overview, 10) }}</p>
                                        </ul>
    ...
    <script>
        $(document).ready(function() {
            $('.catalog__select').change(function() {
                let category = $('select[name="genres"]').val();
