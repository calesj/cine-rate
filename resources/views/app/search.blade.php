        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-xl-6">
                    <h1 class="section__title section__title--head">{{ !empty($category) ? $category : 'Todos os gêneros' }}</h1>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card card--big">
                                ...
                                <div class="card__content">
                                    ...
                                    <ul class="card__info">
                                        <li><span>Director:</span><span><a href="#">Rian Johnson</a></span></li>
                                    </ul>
                                    <p class="card__tagline">«One man's struggle to take it easy»</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card card--big">
                                ...
                                <div class="card__content">
                                    ...
                                    <ul class="card__info">
                                        <li><span>Director:</span><span><a href="#">Francis Lee</a></span></li>
                                    </ul>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card card--big">
                                ...
                                <div class="card__content">
                                    ...
                                    <ul class="card__info">
                                        <li><span>Director:</span><span><a href="#">Pete Docter</a></span></li>
                                    </ul>
                                    <p class="card__tagline">«In space no one can hear you scream»</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card card--big">
                                ...
                                <div class="card__content">
                                    ...
                                    <ul class="card__info">
                                        <li><span>Director:</span><span><a href="#">Stephen Schible</a></span></li>
                                    </ul>
                                    <p class="card__tagline">«The longer you wait, the harder it gets»</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card card--big">
                                ...
                                <div class="card__content">
                                    ...
                                    <ul class="card__info">
                                        <li><span>Director:</span><span><a href="#">Sang-ho Yeon</a></span></li>
                                    </ul>
                                    <p class="card__tagline">«There's more than one way to lose your life to a killer»</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card card--big">
                                ...
                                <div class="card__content">
                                    ...
                                    <ul class="card__info">
                                        <li><span>Director:</span><span><a href="#">Andrea Di Stefano</a></span></li>
                                    </ul>
                                    <p class="card__tagline">«The first casualty of war is innocence»</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card card--big">
                                ...
                                <div class="card__content">
                                    ...
                                    <ul class="card__info">
                                        <li><span>Director:</span><span><a href="#">Tara Miele</a></span></li>
                                    </ul>
                                    <p class="card__tagline">«Love is a force of nature»</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card card--big">
                                ...
                                <div class="card__content">
                                    ...
                                    <ul class="card__info">
                                        <li><span>Director:</span><span><a href="#">Samantha Housman</a></span></li>
                                    </ul>
                                    <p class="card__tagline">«Escape or die frying»</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card card--big">
                                ...
                                <div class="card__content">
                                    ...
                                    <ul class="card__info">
                                        <li><span>Director:</span><span><a href="#">Lynette Howell Taylor</a></span></li>
                                    </ul>
                                    <p class="card__tagline">«Everyone wants to be found»</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card card--big">
                                ...
                                <div class="card__content">
                                    ...
                                    <ul class="card__info">
                                        <li><span>Director:</span><span><a href="#">Monica Levinson</a></span></li>
                                    </ul>
                                    <p class="card__tagline">«There is no gene for the human spirit»</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card card--big">
                                ...
                                <div class="card__content">
                                    ...
                                    <ul class="card__info">
                                        <li><span>Director:</span><span><a href="#">Shivani Rawat</a></span></li>
                                    </ul>
                                    <p class="card__tagline">«Fear can hold you prisoner. Hope can set you free»</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card card--big">
                                ...
                                <div class="card__content">
                                    ...
                                    <ul class="card__info">
                                        <li><span>Director:</span><span><a href="#">Vanessa Bayer</a></span></li>
                                    </ul>
                                    <p class="card__tagline">«Who will survive and what will be left of them?»</p>
                                </div>
                            </div>
                        </div>
                    </div>
