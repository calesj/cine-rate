        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="section__carousel-wrap">
                    ...
                    <button class="section__nav section__nav--cards section__nav--prev" data-nav="#binge" type="button">
                    ...
                    <button class="section__nav section__nav--cards section__nav--next" data-nav="#binge" type="button">
                        <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
